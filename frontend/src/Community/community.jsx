...
const CommunityChat = () => {
  ...
  useEffect(() => {
    const fetchRooms = async () => {
      try {
        const response = await axios.get(`${import.meta.env.VITE_BASE_API_URL}/api/community/rooms`, {
          headers: {
  ...
  const joinRoom = async (roomId) => {
    try {
      ...
      response= await axios.post(
        `${import.meta.env.VITE_BASE_API_URL}/api/community/join`,
        { roomId },
        {
          headers: {
            Authorization: `Bearer ${accessToken}`,
      ...
      response = await axios.get(`${import.meta.env.VITE_BASE_API_URL}/api/community/rooms`, {
        headers: {
          Authorization: `Bearer ${accessToken}`,
        },
      });
  ...
  const sendMessage = async (e) => {
    ...
    try {
      await axios.post(
          `${import.meta.env.VITE_BASE_API_URL}/api/community/message`,
        {
          roomId: joinedRoom,
  ...
  const createRoom = async () => {
    try {
      const response = await axios.post(
        `${import.meta.env.VITE_BASE_API_URL}/api/community/create`,
        {
      ...
      const roomsResponse = await axios.get(`${import.meta.env.VITE_BASE_API_URL}/api/community/rooms`, {
        headers: {
          Authorization: `Bearer ${accessToken}`,
        },
      });

...
<h2 className="text-3xl font-semibold mb-6 border-b-2 border-gray-500 pb-2 inline-block">
  Your To-Do Today
</h2>
<h3 className="text-2xl font-medium text-purple-300">{suggestedActivity.title}</h3>

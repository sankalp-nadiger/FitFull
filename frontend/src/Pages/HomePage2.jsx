        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-2">
              ...
              <span className="text-2xl font-bold" style={{ color: "#403c39" }}>
                Ayurjanani
              </span>
            </div>
            ...
            <div className="flex items-center space-x-4">
              <button
                ...
                style={{ color: "#403c39" }}
                onMouseEnter={(e) => (e.target.style.color = "#638473")}
                onMouseLeave={(e) => (e.target.style.color = "#403c39")}
              >
              ...
              <button
                ...
                className="flex items-center space-x-2 text-white px-6 py-2 rounded-lg transition-all duration-200 transform hover:scale-105 shadow-lg"
                style={{ backgroundColor: "#638473" }}
                onMouseEnter={(e) =>
                  (e.target.style.backgroundColor = "#557a68")
                }
                onMouseLeave={(e) =>
                  (e.target.style.backgroundColor = "#638473")
                }
              >
        ...
        >
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              >
                ...
                <span style={{ color: "#2F4F4F" }}>Doctor</span>
              </h1>
              <p
              ...
              >
                ...
                Support healthier pregnancies with our comprehensive digital
                platform.
              </p>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span style={{ color: "#403c39" }}>
                  Comprehensive prenatal care tools
                </span>
              </div>
            </div>
            ...
            <div className="pt-6">
              <button
                ...
                className="text-white px-8 py-4 rounded-xl text-lg font-semibold transition-all duration-200 transform hover:scale-105 shadow-xl hover:shadow-2xl"
                style={{ backgroundColor: "#c17754" }}
                onMouseEnter={(e) =>
                  (e.target.style.backgroundColor = "#a86644")
                }
                onMouseLeave={(e) =>
                  (e.target.style.backgroundColor = "#c17754")
                }
              >
                Get Started Today
              </button>
          ...
          <div className="relative">
            ...
            <div
              ...
              style={{ backgroundColor: "#c17754", animationDelay: "1000ms" }}
            ></div>
          </div>
        </div>
      </main>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="space-y-4">
              ...
              <p className="text-sm" style={{ color: "#6b6b6b" }}>
                Connecting healthcare providers with expecting mothers for

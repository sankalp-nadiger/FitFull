...
import { FaHome, FaUserMd, FaUser, FaSignOutAlt, FaMapMarkerAlt, FaEnvelope, FaPhone, FaVideo } from 'react-icons/fa';
    ...
    <div className="min-h-screen bg-gray-100 flex">
      ...
      <div className="w-1/4 bg-white text-blue p-6 flex flex-col items-center">
        ...
        <div className="space-y-4 w-full" >
          ...
          <button className="flex items-center w-full px-4 py-2 rounded-xl text-left hover:bg-sky-100" onClick={() => navigate('/patient-dashboard')}>
